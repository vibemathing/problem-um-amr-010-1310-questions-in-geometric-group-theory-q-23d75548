...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1310-questions-in-geometric-group-theory-q-23d75548",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1310-588b382372a9",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1310"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $G$ be a one-relator group whose relator $W$ is a cyclically reduced word in the generators, and let $P$ be the submonoid of $G$ generated by all prefixes of $W$. Is the membership problem for $P$ in $G$ decidable?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 13.10",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "5b48f508aaf68edfce6d4e5a5acca1360e3b47b943133ac2800a18ba5c4f54f0"
}
```
